...
contract BummyBase is BummyAccessControl, ERC721Enumerable, BummyBaseInterface {
    ...
    function _transfer(
        ...
        // require(
        //     owner == _from ||
        //         isApprovedForAll(owner, _from) ||
        //         _tokenApprovals[tokenID] == _from,
        //     "BummyBase: transfer caller is not owner nor approved"
        // );
        // require(_to != address(0), "BummyBase: transfer to the zero address");
        // beforeTokenTransfer(_from, _to, _tokenId, 1);
        // require(owner == _from)
        ...
        // afterTokenTransfer(_from, _to, _tokenId, 1);
